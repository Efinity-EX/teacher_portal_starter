...
<template>
  <VRow>
    ...
    >
      ...
      >
        <p>
          To change the default <code>inset</code> switch, simply modify the inset prop to
    ...
    >
      ...
      >
        <p>
          Multiple <code>v-switch</code>'s can share the same <code>v-model</code> by
          using an array.
        </p>
    ...
    >
      ...
      >
        <p>
          Switch labels can be defined in <code>label</code> slot - that will allow to use
          HTML content.
        </p>
