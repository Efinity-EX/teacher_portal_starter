...
<template>
  <VRow>
    ...
    >
      ...
      >
        <p>
          You can use <code>density</code> prop to reduce the field height and lower max
    ...
    >
      ...
      >
        <p>
          You can specify the specific properties within your items array that correspond
          to the title and value fields. In this example we also use the return-object
    ...
    >
      ...
      >
        <p>
          The <code>selection</code> slot can be used to customize the way selected values
          are shown in the input.
        </p>
