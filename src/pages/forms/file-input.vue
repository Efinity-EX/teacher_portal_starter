...
<template>
  <VRow class="match-height">
    ...
    >
      ...
      >
        <p>
          You can reduces the file input height with <code>density</code> prop. Available
    ...
    >
      ...
      >
        <p>
          <code>v-file-input</code> component can accept only specific media formats/file
          types if you want.
        </p>
    ...
    >
      ...
      >
        <p>
          When using the <code>show-size</code> property along with <code>counter</code>,
    ...
    >
      ...
      >
        <p>
          The <code>v-file-input</code> can contain multiple files at the same time when
          using the <code>multiple</code> prop.
        </p>
    ...
    >
      ...
      >
        <p>
          The <code>v-file-input</code> has a default <code>prepend-icon</code> that can
          be set on the component or adjusted globally.
        </p>
    ...
    >
      ...
      >
        <p>
          You can use the <code>rules</code> prop to create your own custom validation
          parameters.
        </p>
    ...
    >
      ...
      >
        <p>
          Using the <code>selection</code> slot, you can customize the appearance of your
          input selections.
        </p>
