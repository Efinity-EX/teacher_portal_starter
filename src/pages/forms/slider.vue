...
<template>
  <VRow class="match-height">
    ...
    >
      ...
      >
        <p>
          The <code>v-slider</code> component is a better visualization of the number
          input.
        </p>
    ...
    >
      ...
      >
        <p>
          ...
          <code>color</code>, <code>track-color</code> and <code>thumb-color</code>.
        </p>
    ...
    >
      ...
      >
        <p>
          Using the <code>step</code> prop you can control the precision of the slider,
          and how much it should move each step.
        </p>
    ...
    >
      ...
      >
        <p>
          ...
          <code>track-size</code> prop to increase and decrease the size of thumb, tick
          and track.
        </p>
    ...
    >
      ...
      >
        <p>
          You can use the <code>vertical</code> prop to switch sliders to a vertical
          orientation.
        </p>
    ...
    >
      ...
      >
        <p>
          ...
          <code>append</code> slot, such as <code>v-text-field</code>, to add additional
    ...
    >
      ...
      >
        <p>
          Use slots such as <code>append</code> and <code>prepend</code> to easily
