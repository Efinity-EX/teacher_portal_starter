...
<template>
  <VRow class="match-height">
    ...
    >
      ...
      >
        <p>
          Use <code>density</code> prop to reduces the input height. Available options
    ...
    >
      ...
      >
        <p>
          Checkboxes can be colored by using any of the builtin colors and contextual
    ...
    >
      ...
      >
        <p>
          Multiple <code>v-checkbox</code>'s can share the same <code>v-model</code> by
          using an array.
        </p>
    ...
    >
      ...
      >
        <p>
          Use <code>false-icon</code> and <code>true-icon</code> prop to change the icon
          on the checkbox.
        </p>
    ...
    >
      ...
      >
        <p>
          Use <code>false-value</code> and <code>true-value</code> prop to sets value for
          truthy and falsy state
        </p>
    ...
    >
      ...
      >
        <p>
          Checkbox labels can be defined in <code>label</code> slot - that will allow to
          use HTML content.
        </p>
