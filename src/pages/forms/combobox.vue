...
<template>
  <VRow class="match-height">
    ...
    >
      ...
      >
        <p>
          With Combobox, you can allow a user to create new values that may not be present
    ...
    >
      ...
      >
        <p>
          You can use <code>Density</code> prop to reduce combobox height and lower max
          height of list items. Available options are: <code>default</code>,
    ...
    >
      ...
      >
        <p>
          ...
          to change the look of combobox.
        </p>
