...
<template>
  <VRow class="match-height">
    ...
    >
      ...
      >
        <p>
          ...
          levels of density; <code>default</code>,<code>comfortable</code>, and
          <code>compact</code>.
        </p>
    ...
    >
      ...
      >
        <p>
          The <code>prefix</code> and <code>suffix</code> properties allows you to prepend
          and append inline non-modifiable text next to the text field.
        </p>
    ...
    >
      ...
      >
        <p>
          <code>single-line</code> text fields do not float their label on focus or with
          data.
        </p>
    ...
    >
      ...
      >
        <p>
          ...
          <code>click:append-inner</code>, and <code>click:clear</code> will be emitted
    ...
    >
      ...
      >
        <p>
          Text field label can be defined in <code>label</code> slot - that will allow to
          use HTML content.
        </p>
    ...
    >
      ...
      >
        <p>
          Using the HTML input <code>type</code> password can be used with an appended
          icon and callback to control the visibility.
        </p>
    ...
    >
      ...
      >
        <p>
          Instead of using <code>prepend</code>/<code>append</code>/<code>append-inner</code>
