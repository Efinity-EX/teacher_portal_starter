...
<template>
  <VRow class="match-height">
    ...
    >
      ...
      >
        <p>
          Radios can be colored by using any of the built-in colors and contextual names
    ...
    >
      ...
      >
        <p>
          Radio Group labels can be defined in <code>label</code> slot - that will allow
          to use HTML content.
        </p>
    ...
    >
      ...
      >
        <p>
          Use <code>false-icon</code> and <code>true-icon</code> prop to set icon on
    ...
    >
      ...
      >
        <p>
          ...
          <code>function</code>, <code>boolean</code> and <code>string</code>. Functions
          pass an input value as an argument and must return either <code>true</code> /
          <code>false</code> or a string containing an error message.
        </p>
