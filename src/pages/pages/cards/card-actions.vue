  ...
  <VRow>
    ...
    >
      ...
      >
        <VCardText>
          <p>
            You can specifically add Initial Load action using
    ...
    >
      ...
      >
        <VCardText>
          <p>
            You can specifically add collapsible action using
            <code>actionCollapse</code> prop
          </p>
          <span>Click on <VIcon
            size="20"
            icon="tabler-chevron-up"
    ...
    >
      ...
      >
        <VCardText>
          <p>
            You can specifically add remove action using
            <code>actionRemove</code> prop
          </p>
          <span>Click on <VIcon
            size="20"
            icon="tabler-x"
    ...
    >
      ...
      >
        ...
        <VCardText>
          <p>
            <code>app-card-actions</code> also provides <code>before-actions</code> and
            <code>after-actions</code> slot
          </p>
