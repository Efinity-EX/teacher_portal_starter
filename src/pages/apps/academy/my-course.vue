    ...
    <VCard class="mb-6">
      <VCardText class="py-12 position-relative">
        <div
          ...
          :class="
            $vuetify.display.mdAndUp ? 'w-50' : $vuetify.display.xs ? 'w-100' : 'w-75'
          "
        >
          <h4
          ...
          >
            <div class="d-flex flex-column align-center gap-y-4 h-100 justify-center">
              ...
              <p class="text-body-1 text-center mb-0">
                We offers 284 Free Online courses from top tutors and companies to
                help you start or advance your career skills. Learn online for free
                and fast today!
              </p>
            ...
            >
              ...
              <VCardText>
                ...
                <p class="text-body-1 mb-0">
                  In the same way as any other artistic domain, singing lends
                  itself perfectly to self-teaching.
                </p>
              </VCardText>
            </VCard>
          </VCol>
          ...
          >
            ...
            >
              ...
              <VCardText>
                ...
                <p class="text-body-1 mb-0">
                  The Fender Acoustic Guitar is best choice for beginners and
                  professionals.
                </p>
              </VCardText>
            </VCard>
