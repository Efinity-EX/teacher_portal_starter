...
const categoryData = ref([
  ...
  },
  {
    ...
    description:
            'Monitor your health and fitness goals with our range of advanced fitness trackers.',
    totalProduct: 1987,
    totalEarning: 32067,
    image: product10,
  },
  {
    ...
    description:
            'Transform your home into a smart home with our innovative smart home devices.',
    totalProduct: 2345,
    totalEarning: 87654,
    image: product11,
  },
        ...
        >
          ...
          <template #item.totalEarning="{ item }">
            <div class="text-body-1 text-end pe-4">
              {{
                item.totalEarning.toLocaleString('en-IN', {
                  style: 'currency',
                  currency: 'USD',
                })
              }}
