...
<template>
  <VRow class="match-height">
    ...
    >
      ...
      >
        <p>
          The <code>variant='outline'</code> prop is used to give outline to pagination
          item.
        </p>
    ...
    >
      ...
      >
        <p>
          The <code>rounded</code> prop allows you to render pagination buttons with
          alternative styles.
        </p>
    ...
    >
      ...
      >
        <p>
          The <code>variant='outline'</code> and <code>rounded</code> prop is used to give
          rounded outline to pagination item.
        </p>
    ...
    >
      ...
      >
        <p>
          ...
          <code>v-pagination</code>, if the number of page buttons exceeds the parent
          container, it will truncate the list.
        </p>
    ...
    >
      ...
      >
        <p>
          Use <code>size</code> prop to sets the height and width of the component.
          Default unit is px. Can also use the following predefined sizes:
          <strong>x-small</strong>, <strong>small</strong>, <strong>default</strong>,
          <strong>large</strong>, and <strong>x-large</strong>.
        </p>
