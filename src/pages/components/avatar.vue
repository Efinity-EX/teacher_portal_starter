...
<template>
  <VRow class="match-height">
    ...
    >
      ...
      >
        <p>
          The <code>size</code> prop allows you to change the height and width of the
          avatar.
        </p>
    ...
    >
      ...
      >
        <p>
          You can use <code>icon</code> prop of <code>v-avatar</code> component for
          rendering icons.
        </p>
    ...
    >
      ...
      >
        <p>
          You can use <code>image</code> prop of <code>v-avatar</code> component for
          rendering image.
        </p>
