...
<template>
  <VRow>
    ...
    <VCol cols="12">
      ...
      >
        <p>
          The <code>flat</code> buttons still maintain their background color, but have no
          box shadow.
        </p>
        <DemoButtonFlat />
      </AppCardCode>
    ...
    <VCol cols="12">
      ...
      >
        <p>
          Use <code>text</code> variant option to create text button. Text buttons have no
          box shadow and no background.
        </p>
        <DemoButtonText />
      </AppCardCode>
    </VCol>
    ...
    <VCol cols="12">
      ...
      >
        <p>
          Use <code>plain</code> variant option to a create a plain button. Plain buttons
          have a lower baseline opacity that reacts to hover and focus.
        </p>
        <DemoButtonPlain />
      </AppCardCode>
    </VCol>
    ...
    <VCol cols="12">
      ...
      >
        <p>
          Use <code>VIcon</code> component inside button to create buttons that looks like
          rest of the theme.
        </p>
        <DemoButtonIconOnly />
      </AppCardCode>
    ...
    <VCol cols="12">
      ...
      >
        <p>
          Using the <code>loading</code> prop, you can notify a user that there is
    ...
    <VCol cols="12">
      ...
      >
        <p>
          Wrap buttons with the <code>v-btn-toggle</code> component to create a group
          button. You can add a visual divider between buttons with the
