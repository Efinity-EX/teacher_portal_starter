...
<template>
  <VRow>
    ...
    >
      ...
      >
        <p>
          A dialog contains two slots, one for its activator and one for its content
          (default). Good for Privacy Policies.
        </p>
    ...
    >
      ...
      >
        <p>
          The <code>v-dialog</code> component makes it easy to create a customized loading
    ...
    >
      ...
      >
        <p>
          Modals that do not fit within the available window space will scroll the
          container.
        </p>
