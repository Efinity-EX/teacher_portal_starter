...
<template>
  <VRow class="match-height">
    ...
    >
      ...
      >
        <p>
          To use the rounded chip, set <code>label</code> props value to
          <strong>false</strong>.
        </p>
    ...
    >
      ...
      >
        <p>
          Selects can use <code>chips</code> to display the selected data. Try adding your
          own tags below.
        </p>
    ...
    >
      ...
      >
        <p>
          Chips can be combined with <code>v-menu</code> to enable a specific set of
          actions for a chip.
        </p>
