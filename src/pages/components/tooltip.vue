...
<template>
  <VRow>
    <VCol cols="12">
      ...
      >
        <p>
          Use the <code>location</code> prop to specify on which side of the element the
          tooltip should show
        </p>
    ...
    <VCol cols="12">
      ...
      >
        <p>
          Delay (in ms) after which tooltip opens (when
          <code>open-on-hover</code> prop is set to true)
        </p>
