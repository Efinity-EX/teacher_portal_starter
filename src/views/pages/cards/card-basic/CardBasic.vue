  ...
  <VRow>
    ...
    >
      <VCard>
        ...
        <VCardText>
          Cancun is back, better than ever! Over a hundred Mexico resorts have reopened
          and the state tourism minister predicts Cancun will draw as many visitors in
          2006 as it did two years ago.
        </VCardText>
      </VCard>
    </VCol>
      ...
      <VCard>
        ...
        <VCardActions>
          ...
          >
            <VIcon
              :icon="
                isCardDetailsVisible ? 'tabler-chevron-up' : 'tabler-chevron-down'
              "
            />
          </VBtn>
        </VCardActions>
        ...
        <div class="d-flex flex-column-reverse flex-md-row">
          <div>
            ...
            <VCardText>
              ...
              because how are you supposed to build.
            </VCardText>
    ...
    >
      <VCard>
        ...
        <VCardText>
          ...
          <p class="mb-0">
            3.1GHz 6-core 10th-generation Intel Core i5 processor, Turbo Boost up to
            4.5GHz
          </p>
        </VCardText>
        ...
        <VRow no-gutters>
          ...
          >
            ...
            <VCardText>
              ...
              without giving them a second thought such as Coca Cola, body muscles and
              holding ones own breath. Though, most of these notes are not
              fundamentally necessary, they are such that you can use them for a good
    ...
    >
      <VCard title="Influencing The Influencer">
        <VCardText>
          ...
          bar codes with handhelds and workers in the field stay in touch.
        </VCardText>

        <VCardText>
          If you're in the market for new desktops, notebooks, or PDAs, there are a myriad
          of choices.
        </VCardText>
    ...
    >
      <VCard title="The Best Answers">
        ...
        <VCardText>
          ...
          more money, maybe printing is one of the options you won't resist.
        </VCardText>

        <VCardText>
          become fast, easy and simple. If you want your promotional material to be an
          eye-catching
        </VCardText>
      ...
      <VCard class="text-center">
        ...
        <VCardText>
          <p>
            ...
            very often in our daily lives. It is a very common occurrence like cold or
            fever depending upon your lifestyle.
          </p>
        </VCardText>
