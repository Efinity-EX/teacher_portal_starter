...
<template>
  <div class="alert-demo-v-model-wrapper">
    <VAlert
      ...
      variant="tonal"
    >
      non adipiscing dolor urna a orci. Sed mollis, eros et ultrices tempus, mauris ipsum
      aliquam libero, non adipiscing dolor urna a orci. Curabitur blandit mollis lacus.
