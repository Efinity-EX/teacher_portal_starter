...
const albumImages = [TimelineRectangle1, TimelineRectangle2, TimelineRectangle3, TimelineRectangle4]
    ...
    >
        ...
        <VCard class="mb-10 mt-n4">
          ...
          <VCardText>
            ...
            <p class="app-timeline-text mb-3">
              ...
              documents that are required to implement it successfully. Simply put,
              it's an umbrella term which includes all the documents created over the
      ...
      >
        ...
        <VCard class="mb-10 mt-n4">
          ...
          <VCardText>
            <p class="mb-3">
              In the Select Image for Project dialog box, choose one of the following:
              Under the Upload New Image section
            </p>
      ...
      >
        ...
        <VCard class="mb-10 mt-n4">
          <VCardItem class="pb-4">
            <VCardTitle> Loretta write a review on Themeselection </VCardTitle>
          </VCardItem>
          <VCardText>
            <div>
              ...
              <div class="text-body-1">
                I wish I could select more than one main reason for rating this. I
                love how they constantly work on to make the template better. I am
                so thankful for this. Also, in the past, they had responded well to
                my tickets. Thank you for this great theme, for such an amazing
                support, for the better updates. I wish I could rate this for so
                many times. I highly recommend this template!
              </div>
            </div>
          </VCardText>
        </VCard>
        ...
        <VCard class="mb-10 mt-n4">
          ...
          <VCardText>
            <p class="mb-3">
              ...
              considering the attainment of the corporate objectives and therefore
              also project objectives. The components of the project process are
            </p>
